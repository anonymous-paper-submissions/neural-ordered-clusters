...
if __name__ == '__main__':
    ...
    parser.add_argument('--iterations', type=int, default=50000, metavar='N',
                        help='number of iterations (examples) to train (default: 50000)')
    ...
    parser.add_argument('--learning-rates-consecutive', type=dict, default={20000: 5e-5, 40000: 1e-5}, metavar='N',
                        help='A dictionary of iterations as keys and consecutive learning rates as values. (default: {20000: 5e-5, 40000: 1e-5})')
